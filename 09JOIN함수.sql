...
SELECT * FROM INFO INNER JOIN AUTH ON INFO.AUTH_ID = AUTH.AUTH_ID; -- 붙일 수 없는 데이터는 안나옴
...
-- FULL OUTER JOIN - 양쪽 테이블이 누락 없이 다 나온다
SELECT *
FROM INFO I
...
LEFT JOIN JOBS J
ON E.JOB_ID = J.JOB_ID
WHERE J.JOB_TITLE LIKE 'Stock Manager' OR J.JOB_TITLE LIKE 'Stock Clerk';
